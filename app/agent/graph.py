...
from app.agent.nodes import comparison_or_strategy, company_analysis, final_response, research_planner, supplementary_research, tool_execution, understand_request
...
def build_investment_agent():
    ...
    graph.add_node("supplementary_research", supplementary_research)
    ...
    graph.add_edge("company_analysis", "supplementary_research"); graph.add_edge("supplementary_research", "comparison_or_strategy"); graph.add_edge("comparison_or_strategy", "final_response"); graph.add_edge("final_response", END)
